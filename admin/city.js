...
var city =  [
            ...
            "</optgroup><optgroup label='Brandenburg/Berlin'>",
            ...
            "</optgroup><optgroup label='Niedersachsen/Bremen'>",
            ...
            "</optgroup><optgroup label='Rheinland-Pfalz/Saarland'>",
            ...
            "</optgroup><optgroup label='Schleswig-Holstein/Hamburg'>",
...
var city_solo =  [
            ...
            'Ulm'/*,
            '- Bayern'/*,
            'Augsburg','Bayreuth','Coburg','Kempten','Landshut','München','Nürnberg','Passau','Regensburg','Rosenheim','Würzburg',
            '- Brandenburg/Berlin',
            'Berlin','Cottbus','Wittenberg',
            '- Hessen',
            'Frankfurt am Main','Fulda','Giessen','Kassel',
            '- Mecklenburg-Vorpommern',
            'Neubrandenburg','Rostock','Schwerin',
            '- Niedersachsen/Bremen',
            'Bremen','Hannover','Meppen','Oldenburg','Osnabrück','Uelzen',
            '- Nordrhein-Westfalen',
            'Aachen','Bielefeld','Dortmund','Düsseldorf','Köln','Siegen',
            '- Rheinland-Pfalz/Saarland',
            'Kaiserslautern','Koblenz','Mainz','Saarbrücken','Trier',
            '- Sachsen',
